...
{
    console.log("OnMetaDataCallback");
    console.log(data);
    var list = $("#metadata");
    for (var key in data) {
...
function OnBrowserReload(data)
{
    console.log("OnBrowserReload");
}

function OnNativeGoBack(data) {
    console.log("OnNativeGoBack");
    NativeFuncDataCallback("browserGoBack", "", OnGeoPosStartListening);
}

function OnBrowserGoBack(data) {
    console.log("OnBrowserGoBack");
    NativeFuncDataCallback("browserGoBack", "", OnGeoPosStartListening);
}

function OnBrowserGoForward(data) {
    console.log("OnBrowserGoForward");
}

function OnSaveProperty(data) {
    NativeFuncDataCallback("loadAllProperties", "", OnLoadAllProperties);

    console.log("OnSaveProperty");
}

function OnLoadAllProperties(data)
{
    console.log("OnLoadAllProperties");

    var container = $("#properties");

    var list = "<ul>";
    for (var entry in data) {
        var item = "<li>" + data[entry].key + ": " + data[entry].value + "</li>";
        list += item;
    }
    list += "</ul>";
...
$(document).ready(function () {
    ...
    $("#browserReloadButton").on("click", function () {

        console.log("Browser: Reload ...");

        NativeFuncDataCallback("browserReload", "", OnGeoPosStartListening);
    });

    //$("#browserGoBackButton").on("click", function () {

    //    console.log("Browser: Go back ...");

    //    NativeFuncDataCallback("browserGoBack", "", OnGeoPosStartListening);
    //});
    $("#browserGoBackButton").on("click", OnBrowserGoBack);

    $("#browserGoForwardButton").on("click", function () {

        console.log("Browser: Go forward ...");

        NativeFuncDataCallback("browserGoForward", "", OnGeoPosStartListening);
    });

    $("#propertyForm").on("submit", function (e) {
        e.preventDefault();

        var keyS = $("#propertyKey").val();
        var valueS = $("#propertyValue").val();

        NativeFuncDataCallback("saveProperty", { key: keyS, value: valueS }, OnSaveProperty);
    });
